...
public interface OrganizationService {
    ...
    /**
     * Initiates organization creation by generating an OTP and sending it to the
     * user's email.
     * The organization is not created until the OTP is verified.
     *
    ...
    /**
     * Verifies the OTP and creates the organization.
     *
     * @param request The OTP verification request
     * @param userId  The ID of the user creating the organization
     * @return Response with the created organization details
     */
     ...
     */
    UnravelDocsResponse<OrganizationMemberResponse> addMember(String orgId, AddMemberRequest request, String adminId);
    ...
    /**
     * Removes multiple members from an organization in batch.
     * Only ADMIN or OWNER can remove members.
     *
     * @param orgId   The organization ID
     ...
     * @param ownerId The ID of the organization owner
     ...
     * Only OWNER can close the organization.
    ...
    /**
     * Reactivates a closed organization.
     * Only OWNER can reactivate the organization.
     *
     * @param orgId   The organization ID
     * @param ownerId The ID of the organization owner
     * @return Response with the reactivated organization details
     */
