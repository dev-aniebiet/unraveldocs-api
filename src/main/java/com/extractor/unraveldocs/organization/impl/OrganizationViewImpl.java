...
public class OrganizationViewImpl {
        ...
        @Cacheable(value = "organizations", key = "#orgId + '-' + #userId")
        public UnravelDocsResponse<OrganizationResponse> getOrganization(String orgId, String userId) {
                log.debug("Getting team {} for user {}", sanitizer.sanitizeLogging(orgId), sanitizer.sanitizeLogging(userId));
        ...
        public UnravelDocsResponse<List<OrganizationMemberResponse>> getMembers(String orgId, String userId) {
                log.debug("Getting members of team {} for user {}", sanitizer.sanitizeLogging(orgId), sanitizer.sanitizeLogging(userId));
        ...
        public UnravelDocsResponse<List<OrganizationResponse>> getMyOrganizations(String userId) {
                log.debug("Getting organizations for user {}", sanitizer.sanitizeLogging(userId));
