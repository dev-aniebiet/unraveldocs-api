...
public class OrganizationController {
        ...
        @Operation(summary = "Initiate team creation", description = "Sends OTP to user email to verify team creation. Requires Premium or Enterprise subscription.")
        ...
        @PostMapping("/verify")
        @Operation(summary = "Verify OTP and create team", description = "Verifies the OTP and creates the team with 10-day free trial.")
        ...
        @GetMapping("/{orgId}")
        @Operation(summary = "Get team details", description = "Returns team details. Only accessible by members.")
        ...
        @Operation(summary = "Get team members", description = "Returns members list. Email is masked for non-owners (except own email).")
        ...
        @Operation(summary = "Add member to team", description = "Adds a user as a member. Only ADMIN or OWNER can add members. Max 10 members.")
        ...
        @Operation(summary = "Remove member from team", description = "Removes a single member. Only ADMIN or OWNER can remove.")
        ...
        @DeleteMapping("/{orgId}")
        @Operation(summary = "Close team", description = "Closes the team. Only OWNER can close. Members remain but lose access.")
        ...
        @Operation(summary = "Reactivate team", description = "Reactivates a closed team. Only OWNER can reactivate.")
