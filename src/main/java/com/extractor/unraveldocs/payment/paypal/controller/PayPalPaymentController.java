...
import com.extractor.unraveldocs.payment.paypal.dto.response.PayPalPaymentHistoryResponse;
import com.extractor.unraveldocs.payment.paypal.dto.response.PayPalRefundResponse;
import com.extractor.unraveldocs.payment.paypal.dto.response.PayPalSubscriptionHistoryResponse;
...
public class PayPalPaymentController {
        ...
        @GetMapping("/plans")
        @Operation(summary = "List available subscription plans", description = "Get all available PayPal subscription plans. This endpoint is public.")
        public ResponseEntity<Map<String, Object>> listPlans() {
                var plans = planSetupService.listExistingPlans();
        ...
        public ResponseEntity<Map<String, Object>> createOrder(
                ...
                return ResponseEntity.status(HttpStatus.CREATED).body(Map.of(
                                ...
                                "data", Map.of(
                                                ...
                                                "approvalUrl",
                                                order.getApprovalLink() != null ? order.getApprovalLink() : "",
                                                "links",
                                                order.getLinks() != null ? order.getLinks() : java.util.List.of())));
        }
        ...
        public ResponseEntity<Map<String, Object>> captureOrder(@PathVariable String orderId) {
                ...
                return ResponseEntity.ok(Map.of(
                                ...
                                "data", Map.of(
                                                ...
                                                "currency",
                                                capture.getCurrency() != null ? capture.getCurrency() : "")));
        }
        ...
        public ResponseEntity<Page<PayPalPaymentHistoryResponse>> getPaymentHistory(
                        @AuthenticationPrincipal User user,
                        Pageable pageable) {

                Page<PayPalPayment> payments = paymentService.getUserPayments(user.getId(), pageable);
                Page<PayPalPaymentHistoryResponse> response = payments.map(PayPalPaymentHistoryResponse::fromEntity);
                return ResponseEntity.ok(response);
        }

        @GetMapping("/payments/{orderId}")
        @Operation(summary = "Get payment by order ID", description = "Get a specific payment by its order ID")
        public ResponseEntity<PayPalPaymentHistoryResponse> getPaymentByOrderId(@PathVariable String orderId) {
                return paymentService.getPaymentByOrderId(orderId)
                                .map(PayPalPaymentHistoryResponse::fromEntity)
        ...
        public ResponseEntity<Map<String, Object>> createSubscription(
                ...
                return ResponseEntity.status(HttpStatus.CREATED).body(Map.of(
                                ...
                                "data", Map.of(
                                                ...
                                                "approvalUrl",
                                                subscription.getApprovalLink() != null ? subscription.getApprovalLink()
                                                                : "")));
        }
        ...
        public ResponseEntity<PayPalSubscriptionHistoryResponse> getActiveSubscription(
                        @AuthenticationPrincipal User user) {
                return subscriptionService.getActiveSubscriptionByUserId(user.getId())
                                .map(PayPalSubscriptionHistoryResponse::fromEntity)
                                .map(ResponseEntity::ok)
                                .orElse(ResponseEntity.notFound().build());
        }
        ...
        public ResponseEntity<Page<PayPalSubscriptionHistoryResponse>> getSubscriptionHistory(
                        @AuthenticationPrincipal User user,
                        Pageable pageable) {

                Page<PayPalSubscription> subscriptions = subscriptionService.getSubscriptionsByUserId(user.getId(),
                                pageable);
                Page<PayPalSubscriptionHistoryResponse> response = subscriptions
                                .map(PayPalSubscriptionHistoryResponse::fromEntity);
                return ResponseEntity.ok(response);
        }
        ...
        public ResponseEntity<Map<String, Object>> cancelSubscription(
                ...
                PayPalSubscriptionResponse subscription = subscriptionService.cancelSubscription(subscriptionId,
                                reason);
        ...
        public ResponseEntity<Map<String, Object>> suspendSubscription(
                ...
                PayPalSubscriptionResponse subscription = subscriptionService.suspendSubscription(subscriptionId,
                                reason);
        ...
        public ResponseEntity<Map<String, Object>> activateSubscription(
                ...
                PayPalSubscriptionResponse subscription = subscriptionService.activateSubscription(subscriptionId,
                                reason);
