...
public class PaystackPaymentController {
    ...
    public ResponseEntity<Page<PaystackPayment>> getPaymentHistory(
            @AuthenticationPrincipal User user,
            Pageable pageable) {
    ...
    public ResponseEntity<PaystackPayment> getPaymentByReference(@PathVariable String reference) {
    ...
    public ResponseEntity<Page<PaystackSubscription>> getSubscriptionHistory(
        ...
        Page<PaystackSubscription> subscriptions = subscriptionService.getSubscriptionsByUserId(user.getId(), pageable);
    ...
    public ResponseEntity<Map<String, Object>> enableSubscription(
        ...
        PaystackSubscription subscription = subscriptionService.enableSubscription(subscriptionCode, emailToken);
    ...
    public ResponseEntity<Map<String, Object>> disableSubscription(
        ...
        PaystackSubscription subscription = subscriptionService.disableSubscription(subscriptionCode, emailToken);
